...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/resources/css/ui.css">
<link rel="stylesheet"
...
<script type="text/javascript">
	...
	Number.prototype.formatNumber = function() {
		...
		let regex = /(^[+-]?\d+)(\d)/;
		let nstr = value.toString().replace(/,/g, ''); // 쉼표 제거
	...
	<form name="orderform" id="orderform" method="post" class="orderform"
		...
		<div class="basket" id="basket">
			...
			<div class="row data">
				...
				<div class="img">
					<img
						src="<%=request.getContextPath()%>/resources/img/sample_product_1.jpg"
						width="60" height="60">
				</div>
		...
		<div class="row data">
			...
			<div class="img">
				<img
					src="<%=request.getContextPath()%>/resources/img/sample_product_4.jpg"
					width="100" height="60">
			</div>
			<div class="pname">
		...
		<div class="row data">
			...
			<div class="img">
				<img
					src="<%=request.getContextPath()%>/resources/img/sample_product_3.jpg"
					width="100" height="60">
			</div>
			<div class="pname">
